...
```json
{
  ...
  "keywords": [
    ...
    "time-aware", "zero-dependency", "autotheme", "react",
...
**Exit Criteria:** Package is live on NPM. `npm i autotheme` installs < 1KB.
...
*This document is the single source of truth for AutoTheme's implementation. Every decision, every file, every function is here. Build exactly this.*
